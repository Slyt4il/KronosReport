...
def user_input_features():
    ...
    with col1:
        a1 = st.selectbox('Position A1', strikers_options, index = 28, format_func=helper.convert_readable)
        a2 = st.selectbox('Position A2', strikers_options, index = 33, format_func=helper.convert_readable)
        a3 = st.selectbox('Position A3', strikers_options, index = 8, format_func=helper.convert_readable)
        a4 = st.selectbox('Position A4', strikers_options, index = 29, format_func=helper.convert_readable)
    with col2:
    ...
    with col3:
        ...
        d2 = st.selectbox('Position D2', strikers_options, index = 33, format_func=helper.convert_readable)
        d3 = st.selectbox('Position D3', strikers_options, index = 21, format_func=helper.convert_readable)
        d4 = st.selectbox('Position D4', strikers_options, index = 8, format_func=helper.convert_readable)
